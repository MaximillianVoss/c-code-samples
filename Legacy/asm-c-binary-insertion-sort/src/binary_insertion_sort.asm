; Compiler-generated NASM retained from the 2021 lab and given a stable home.
; Target ABI: System V AMD64. Each Vehicle record must remain exactly 32 bytes.
; See include/vehicle.h for the checked C layout and preservation/ for originals.
;----------------------------------------------
global binarySearch
